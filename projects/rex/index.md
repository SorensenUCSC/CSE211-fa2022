...
For our final project, we decided to build **REX: a declarative regular expression language**, with SQL-like syntax. The language supports the basic regular expression operators *union* (\|), *concatenation* (.), and *star repeat* (\*). You can find the project [**here**](https://github.com/taidanh/rex).
